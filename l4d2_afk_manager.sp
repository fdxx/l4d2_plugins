...
public void OnPluginStart()
{
	...
	g_cvSpecTime = CreateConVar("l4d2_afk_manager_spec_time", "90.0", "After how many seconds idle players will be forced to change to spectator team. 0.0=Disabled", FCVAR_NONE);
	g_cvKickTime = CreateConVar("l4d2_afk_manager_kick_time", "180.0", "After how many seconds idle spectator players(forced change to spectator) will be kicked from the server. 0.0=Disabled", FCVAR_NONE);
	...
	g_cvPlayersLimit = CreateConVar("l4d2_afk_manager_kick_players_limit", "4", "How many players will the server reach before kicking the player out of the server.", FCVAR_NONE, true, 0.0, true, 32.0);
